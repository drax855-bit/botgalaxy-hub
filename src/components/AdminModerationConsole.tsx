      ...
      meta: [
        ...
        },
        {
          name:
            "description",
          content:
            "Protected BotGalaxy administration area for bot moderation, reports, reviews, users and administrator permissions.",
        },
        {
          name: "robots",
          content:
